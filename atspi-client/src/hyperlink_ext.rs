use atspi_proxies::hyperlink::{Hyperlink, HyperlinkBlocking, HyperlinkProxy, HyperlinkProxyBlocking};
...
impl<T: HyperlinkBlockingExtError + HyperlinkBlocking> HyperlinkBlockingExt
	for T
{
}

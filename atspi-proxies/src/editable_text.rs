...
//! ## Defaults
//!
//! The `EditableText` interface can be implemented on any individual node within the
//! application's UI-tree (such as text input fields). As a consequence, the object path
//! varies per node and no default path is applicable for this proxy.
//!

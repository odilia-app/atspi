...
pub mod object {
  ...
  use zbus_names::UniqueName;
   ...
   pub properties: std::collections::HashMap<String, zvariant::OwnedValue>,
   ...
   pub properties: std::collections::HashMap<String, zvariant::OwnedValue>,
      ...
      const REGISTRY_EVENT_STRING: &'static str = "Object:";
		...
		fn build(item: Accessible, body: Self::Body) -> Self {
			Self {
				item,
				property: body.kind, value: body.any_data, properties: body.properties	
			}
		}
	...
	impl TryFrom<Event> for LinkSelectedEvent {
      ...
      const REGISTRY_EVENT_STRING: &'static str = "Object:";
		...
		fn build(item: Accessible, body: Self::Body) -> Self {
			Self {
				item,
				state: body.kind, enabled: body.detail1, properties: body.properties	
			}
		}
    fn sender(&self) -> UniqueName<'_> {
      self.item.name.clone().into()
	...
	impl TryFrom<Event> for StateChangedEvent {
      ...
      const REGISTRY_EVENT_STRING: &'static str = "Object:";
		...
		fn build(item: Accessible, body: Self::Body) -> Self {
			Self {
				item,
				operation: body.kind, index_in_parent: body.detail1, child: body.any_data, properties: body.properties	
			}
		}
    fn sender(&self) -> UniqueName<'_> {
      self.item.name.clone().into()
	...
	impl TryFrom<Event> for ModelChangedEvent {
      ...
      const REGISTRY_EVENT_STRING: &'static str = "Object:";
		...
		fn build(item: Accessible, body: Self::Body) -> Self {
			Self {
				item,
				child: body.any_data, properties: body.properties	
			}
		}
    fn sender(&self) -> UniqueName<'_> {
      self.item.name.clone().into()
	...
	impl TryFrom<Event> for ActiveDescendantChangedEvent {
      ...
      const REGISTRY_EVENT_STRING: &'static str = "Object:";
		...
		fn build(item: Accessible, body: Self::Body) -> Self {
			Self {
				item,
				text: body.kind, properties: body.properties	
			}
		}
    fn sender(&self) -> UniqueName<'_> {
      self.item.name.clone().into()
	...
	impl TryFrom<Event> for TextSelectionChangedEvent {
      ...
      const REGISTRY_EVENT_STRING: &'static str = "Object:";
		...
		fn build(item: Accessible, body: Self::Body) -> Self {
			Self {
				item,
				detail: body.kind, start_pos: body.detail1, length: body.detail2, text: body.any_data, properties: body.properties	
			}
		}
    fn sender(&self) -> UniqueName<'_> {
      self.item.name.clone().into()
	...
	impl TryFrom<Event> for TextAttributesChangedEvent {
      ...
      const REGISTRY_EVENT_STRING: &'static str = "Object:";
		...
		fn build(item: Accessible, body: Self::Body) -> Self {
			Self {
				item,
				position: body.detail1, properties: body.properties	
			}
		}
    fn sender(&self) -> UniqueName<'_> {
      self.item.name.clone().into()
	...
	impl Default for PropertyChangeEvent {
		fn default() -> Self {
			PropertyChangeEvent {
				...
				property: String::default(), value: zvariant::Value::U8(0).into(), properties: std::collections::HashMap::new()
			}
		}
	}
	...
	impl Default for ChildrenChangedEvent {
		fn default() -> Self {
			ChildrenChangedEvent {
				item: crate::events::Accessible::default(),
				operation: String::default(), index_in_parent: i32::default(), child: zvariant::Value::U8(0).into(), properties: std::collections::HashMap::new()
			}
		}
	}
	...
	impl Default for ActiveDescendantChangedEvent {
		fn default() -> Self {
			ActiveDescendantChangedEvent {
				item: crate::events::Accessible::default(),
				child: zvariant::Value::U8(0).into(), properties: std::collections::HashMap::new()
			}
		}
	}
	...
	impl Default for TextChangedEvent {
		fn default() -> Self {
			TextChangedEvent {
				item: crate::events::Accessible::default(),
				detail: String::default(), start_pos: i32::default(), length: i32::default(), text: zvariant::Value::U8(0).into(), properties: std::collections::HashMap::new()
			}
		}
	}
	...
	impl From<BoundsChangedEvent> for EventBodyOwned {
		fn from(event: BoundsChangedEvent) -> Self {
			EventBodyOwned {
				kind: String::default(), detail1: i32::default(), detail2: i32::default(), any_data: zvariant::Value::U8(0).into(), properties: event.properties
			}
		}
	}
	...
	impl From<StateChangedEvent> for EventBodyOwned {
		fn from(event: StateChangedEvent) -> Self {
			EventBodyOwned {
				kind: event.state, detail1: event.enabled, detail2: i32::default(), any_data: zvariant::Value::U8(0).into(), properties: event.properties
			}
		}
	}
	...
	impl From<AnnouncementEvent> for EventBodyOwned {
		fn from(event: AnnouncementEvent) -> Self {
			EventBodyOwned {
				kind: event.text, detail1: i32::default(), detail2: i32::default(), any_data: zvariant::Value::U8(0).into(), properties: event.properties
			}
		}
	}
	...
	impl From<TextCaretMovedEvent> for EventBodyOwned {
		fn from(event: TextCaretMovedEvent) -> Self {
			EventBodyOwned {
				kind: String::default(), detail1: event.position, detail2: i32::default(), any_data: zvariant::Value::U8(0).into(), properties: event.properties
			}
		}
	}
   ...
   pub properties: std::collections::HashMap<String, zvariant::OwnedValue>,
      ...
      const REGISTRY_EVENT_STRING: &'static str = "Window:";
		...
		fn build(item: Accessible, body: Self::Body) -> Self {
			Self {
				item,
				property: body.kind, properties: body.properties	
			}
		}
    fn sender(&self) -> UniqueName<'_> {
      self.item.name.clone().into()
	...
	impl From<PropertyChangeEvent> for EventBodyOwned {
		fn from(event: PropertyChangeEvent) -> Self {
			EventBodyOwned {
				kind: event.property, detail1: i32::default(), detail2: i32::default(), any_data: zvariant::Value::U8(0).into(), properties: event.properties
			}
		}
	}
   ...
   pub properties: std::collections::HashMap<String, zvariant::OwnedValue>,
      ...
      const REGISTRY_EVENT_STRING: &'static str = "Mouse:";
		...
		fn build(item: Accessible, body: Self::Body) -> Self {
			Self {
				item,
				x: body.detail1, y: body.detail2, properties: body.properties	
			}
		}
    fn sender(&self) -> UniqueName<'_> {
      self.item.name.clone().into()
	...
	impl TryFrom<Event> for RelEvent {
      ...
      const REGISTRY_EVENT_STRING: &'static str = "Mouse:";
		...
		fn build(item: Accessible, body: Self::Body) -> Self {
			Self {
				item,
				detail: body.kind, mouse_x: body.detail1, mouse_y: body.detail2, properties: body.properties	
			}
		}
    fn sender(&self) -> UniqueName<'_> {
      self.item.name.clone().into()
	...
	impl From<AbsEvent> for EventBodyOwned {
		fn from(event: AbsEvent) -> Self {
			EventBodyOwned {
				kind: String::default(), detail1: event.x, detail2: event.y, any_data: zvariant::Value::U8(0).into(), properties: event.properties
			}
		}
	}
	...
	impl From<ButtonEvent> for EventBodyOwned {
		fn from(event: ButtonEvent) -> Self {
			EventBodyOwned {
				kind: event.detail, detail1: event.mouse_x, detail2: event.mouse_y, any_data: zvariant::Value::U8(0).into(), properties: event.properties
			}
		}
	}
   ...
   pub properties: std::collections::HashMap<String, zvariant::OwnedValue>,
      ...
      const REGISTRY_EVENT_STRING: &'static str = "Keyboard:";
		...
		fn build(item: Accessible, body: Self::Body) -> Self {
			Self {
				item,
				previous_modifiers: body.detail1, current_modifiers: body.detail2, properties: body.properties	
			}
		}
    fn sender(&self) -> UniqueName<'_> {
      self.item.name.clone().into()
	...
	impl From<ModifiersEvent> for EventBodyOwned {
		fn from(event: ModifiersEvent) -> Self {
			EventBodyOwned {
				kind: String::default(), detail1: event.previous_modifiers, detail2: event.current_modifiers, any_data: zvariant::Value::U8(0).into(), properties: event.properties
			}
		}
	}

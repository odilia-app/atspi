   ...
   pub properties: std::collections::HashMap<String, zbus::zvariant::OwnedValue>,
	...
	impl TryFrom<AnyEvent> for ObjectEvents {
		...
		fn try_from(ev: AnyEvent) -> Result<Self, Self::Error> {
			...
			match member.as_str() {
				"PropertyChange" => Ok(ObjectEvents::PropertyChange(PropertyChangeEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, property: ev.body.kind, value: ev.body.any_data, properties: ev.body.properties })),
				"BoundsChanged" => Ok(ObjectEvents::BoundsChanged(BoundsChangedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"LinkSelected" => Ok(ObjectEvents::LinkSelected(LinkSelectedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"StateChanged" => Ok(ObjectEvents::StateChanged(StateChangedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, state: ev.body.kind, enabled: ev.body.detail1, properties: ev.body.properties })),
				"ChildrenChanged" => Ok(ObjectEvents::ChildrenChanged(ChildrenChangedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, operation: ev.body.kind, index_in_parent: ev.body.detail1, child: ev.body.any_data, properties: ev.body.properties })),
				"VisibleDataChanged" => Ok(ObjectEvents::VisibleDataChanged(VisibleDataChangedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"SelectionChanged" => Ok(ObjectEvents::SelectionChanged(SelectionChangedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"ModelChanged" => Ok(ObjectEvents::ModelChanged(ModelChangedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"ActiveDescendantChanged" => Ok(ObjectEvents::ActiveDescendantChanged(ActiveDescendantChangedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, child: ev.body.any_data, properties: ev.body.properties })),
				"Announcement" => Ok(ObjectEvents::Announcement(AnnouncementEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, text: ev.body.kind, properties: ev.body.properties })),
				"AttributesChanged" => Ok(ObjectEvents::AttributesChanged(AttributesChangedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"RowInserted" => Ok(ObjectEvents::RowInserted(RowInsertedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"RowReordered" => Ok(ObjectEvents::RowReordered(RowReorderedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"RowDeleted" => Ok(ObjectEvents::RowDeleted(RowDeletedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"ColumnInserted" => Ok(ObjectEvents::ColumnInserted(ColumnInsertedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"ColumnReordered" => Ok(ObjectEvents::ColumnReordered(ColumnReorderedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"ColumnDeleted" => Ok(ObjectEvents::ColumnDeleted(ColumnDeletedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"TextBoundsChanged" => Ok(ObjectEvents::TextBoundsChanged(TextBoundsChangedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"TextSelectionChanged" => Ok(ObjectEvents::TextSelectionChanged(TextSelectionChangedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"TextChanged" => Ok(ObjectEvents::TextChanged(TextChangedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, detail: ev.body.kind, start_pos: ev.body.detail1, length: ev.body.detail2, text: ev.body.any_data, properties: ev.body.properties })),
				"TextAttributesChanged" => Ok(ObjectEvents::TextAttributesChanged(TextAttributesChangedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"TextCaretMoved" => Ok(ObjectEvents::TextCaretMoved(TextCaretMovedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, position: ev.body.detail1, properties: ev.body.properties })),
   ...
   pub properties: std::collections::HashMap<String, zbus::zvariant::OwnedValue>,
	...
	impl TryFrom<AnyEvent> for WindowEvents {
		...
		fn try_from(ev: AnyEvent) -> Result<Self, Self::Error> {
			let Some(member) = ev.member() else { return Err(AtspiError::MemberMatch("Event w/o member".into())); };
			match member.as_str() {
				"PropertyChange" => Ok(WindowEvents::PropertyChange(PropertyChangeEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, property: ev.body.kind, properties: ev.body.properties })),
				"Minimize" => Ok(WindowEvents::Minimize(MinimizeEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"Maximize" => Ok(WindowEvents::Maximize(MaximizeEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"Restore" => Ok(WindowEvents::Restore(RestoreEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"Close" => Ok(WindowEvents::Close(CloseEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"Create" => Ok(WindowEvents::Create(CreateEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"Reparent" => Ok(WindowEvents::Reparent(ReparentEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"DesktopCreate" => Ok(WindowEvents::DesktopCreate(DesktopCreateEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"DesktopDestroy" => Ok(WindowEvents::DesktopDestroy(DesktopDestroyEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"Destroy" => Ok(WindowEvents::Destroy(DestroyEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"Activate" => Ok(WindowEvents::Activate(ActivateEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"Deactivate" => Ok(WindowEvents::Deactivate(DeactivateEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"Raise" => Ok(WindowEvents::Raise(RaiseEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"Lower" => Ok(WindowEvents::Lower(LowerEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"Move" => Ok(WindowEvents::Move(MoveEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"Resize" => Ok(WindowEvents::Resize(ResizeEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"Shade" => Ok(WindowEvents::Shade(ShadeEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"uUshade" => Ok(WindowEvents::UUshade(UUshadeEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"Restyle" => Ok(WindowEvents::Restyle(RestyleEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
   ...
   pub properties: std::collections::HashMap<String, zbus::zvariant::OwnedValue>,
	...
	impl TryFrom<AnyEvent> for MouseEvents {
		...
		fn try_from(ev: AnyEvent) -> Result<Self, Self::Error> {
			let Some(member) = ev.member() else { return Err(AtspiError::MemberMatch("Event w/o member".into())); };
			match member.as_str() {
				"Abs" => Ok(MouseEvents::Abs(AbsEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, x: ev.body.detail1, y: ev.body.detail2, properties: ev.body.properties })),
				"Rel" => Ok(MouseEvents::Rel(RelEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, x: ev.body.detail1, y: ev.body.detail2, properties: ev.body.properties })),
				"Button" => Ok(MouseEvents::Button(ButtonEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, detail: ev.body.kind, mouse_x: ev.body.detail1, mouse_y: ev.body.detail2, properties: ev.body.properties })),
   ...
   pub properties: std::collections::HashMap<String, zbus::zvariant::OwnedValue>,
	...
	impl TryFrom<AnyEvent> for KeyboardEvents {
		...
		fn try_from(ev: AnyEvent) -> Result<Self, Self::Error> {
			let Some(member) = ev.member() else { return Err(AtspiError::MemberMatch("Event w/o member".into())); };
			match member.as_str() {
				"Modifiers" => Ok(KeyboardEvents::Modifiers(ModifiersEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, previous_modifiers: ev.body.detail1, current_modifiers: ev.body.detail2, properties: ev.body.properties })),
   ...
   pub properties: std::collections::HashMap<String, zbus::zvariant::OwnedValue>,
	...
	impl TryFrom<AnyEvent> for TerminalEvents {
		...
		fn try_from(ev: AnyEvent) -> Result<Self, Self::Error> {
			let Some(member) = ev.member() else { return Err(AtspiError::MemberMatch("Event w/o member".into())); };
			match member.as_str() {
				"LineChanged" => Ok(TerminalEvents::LineChanged(LineChangedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"ColumncountChanged" => Ok(TerminalEvents::ColumnCountChanged(ColumnCountChangedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"LinecountChanged" => Ok(TerminalEvents::LineCountChanged(LineCountChangedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"ApplicationChanged" => Ok(TerminalEvents::ApplicationChanged(ApplicationChangedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"CharwidthChanged" => Ok(TerminalEvents::CharWidthChanged(CharWidthChangedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
   ...
   pub properties: std::collections::HashMap<String, zbus::zvariant::OwnedValue>,
	...
	impl TryFrom<AnyEvent> for DocumentEvents {
		...
		fn try_from(ev: AnyEvent) -> Result<Self, Self::Error> {
			let Some(member) = ev.member() else { return Err(AtspiError::MemberMatch("Event w/o member".into())); };
			match member.as_str() {
				"LoadComplete" => Ok(DocumentEvents::LoadComplete(LoadCompleteEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"Reload" => Ok(DocumentEvents::Reload(ReloadEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"LoadStopped" => Ok(DocumentEvents::LoadStopped(LoadStoppedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"ContentChanged" => Ok(DocumentEvents::ContentChanged(ContentChangedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"AttributesChanged" => Ok(DocumentEvents::AttributesChanged(AttributesChangedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
				"PageChanged" => Ok(DocumentEvents::PageChanged(PageChangedEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),
   ...
   pub properties: std::collections::HashMap<String, zbus::zvariant::OwnedValue>,
	...
	impl TryFrom<AnyEvent> for FocusEvents {
		...
		fn try_from(ev: AnyEvent) -> Result<Self, Self::Error> {
			let Some(member) = ev.member() else { return Err(AtspiError::MemberMatch("Event w/o member".into())); };
			match member.as_str() {
				"Focus" => Ok(FocusEvents::Focus(FocusEvent{ item: crate::events::Accessible { name: ev.message.header().unwrap().sender().unwrap().unwrap().to_owned().into(), path: ev.message.path().unwrap().into() }, properties: ev.body.properties })),

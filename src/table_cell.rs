...
#[atspi_proxy(interface = "org.a11y.atspi.TableCell")]
trait TableCell {
	/// GetColumnHeaderCells method
	fn get_column_header_cells(
		&self,
	...
	fn get_row_header_cells(&self) -> zbus::Result<Vec<(String, zbus::zvariant::OwnedObjectPath)>>;
